...
import { addDevices } from '../../utils/requests';
    ...
    csvParser.parse(this.fileInput.current.files[0], {
      complete: (results) => {
        ...
        this.setState({
          ...
          file: payload.splice(0, payload.length - 1),
        });
      },
    });
  };
    ...
    return (
      <StyledDashbord className='Dashboard'>
        ...
        <div className='body'>
          <form className='bulk-user'>
            <div className='input-field'>
              <input
                ...
                ref={this.fileInput}
                accept='.csv'
                onSubmit={(e) => this.handleFileSubmit(e)}
              ...
              <p className='input-info'>
                ...
                device, name and user of the device, if the device has been
                fixed before.
              </p>
            </div>
            <button
              onClick={(e) => this.handleFileSubmit(e)}
              type='submit'
              className='btn'
            >
          ...
          <Link to='/add-device' className='btn add-device-btn'>
